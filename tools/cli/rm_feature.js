...
/* ===== Remove entry from styles/index.scss ===== */
console.log('Remove entry from styles/index.scss');
targetPath = path.join(helpers.getProjectRoot(), 'src/styles/index.scss');
lines = helpers.getLines(targetPath);
helpers.removeLines(lines, `@import '../features/${context.KEBAB_FEATURE_NAME}/style.scss';`);
toSave(targetPath, lines);
