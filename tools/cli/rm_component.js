...
shell.rm(`${targetDir}/${componentName}.scss`);
...
/* ===== Remove from style.scss ===== */
console.log('Remove entry from style.scss');
targetPath = path.join(targetDir, 'style.scss');
lines = helpers.getLines(targetPath);
helpers.removeLines(lines, `@import './${componentName}.scss';`);
toSave(targetPath, lines);
